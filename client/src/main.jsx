    ...
    <section className="wrap">
      ...
      <div style={{ marginTop: "30px" }}>
        ...
        >
          ...
          <ToolCard
  icon={
    <svg xmlns="http://w3.org" viewBox="0 0 800 450" style={{ width: '100%', height: 'auto' }}>
      <defs>
        <filter id="layer-shadow" x="-30%" y="-30%" width="160%" height="160%">
          <feDropShadow dx="-8" dy="22" stdDeviation="14" floodColor="#0F172A" floodOpacity="0.3"/>
        </filter>
      ...
      <g filter="url(#layer-shadow)">
        <g transform="translate(190, 230)">
          <path d="M -90 10 L 0 -35 L 90 10 L 0 55 Z" fill="#0F172A" opacity="0.15"/>
          ...
          <text x="2" y="14" fill="#4C0519" fontFamily="system-ui" fontWeight="900" fontSize="36" textAnchor="middle" transform="matrix(1, 0.45, 0, 0.85, 0, -10)">PDF</text>
          <text x="0" y="12" fill="#FFFFFF" fontFamily="system-ui" fontWeight="900" fontSize="36" textAnchor="middle" transform="matrix(1, 0.45, 0, 0.85, 0, -10)">PDF</text>
        </g>
        <g transform="translate(400, 205)">
          <path d="M -110 5 Q 0 -45 110 5" fill="none" stroke="url(#cyan-glow)" strokeWidth="7" strokeLinecap="round"/>
          <path d="M -110 5 Q 0 -45 110 5" fill="none" stroke="#FFFFFF" strokeWidth="2" strokeDasharray="8 20" strokeLinecap="round"/>
          <polygon points="100,-2 122,7 98,14 103,6" fill="#06B6D4"/>
        </g>
        <g transform="translate(610, 230)">
          ...
          <text x="2" y="16" fill="#1E3A8A" fontFamily="system-ui" fontWeight="900" fontSize="34" textAnchor="middle" transform="matrix(1, 0.45, 0, 0.85, 0, -8)">JPG</text>
          <text x="0" y="14" fill="#FFFFFF" fontFamily="system-ui" fontWeight="900" fontSize="34" textAnchor="middle" transform="matrix(1, 0.45, 0, 0.85, 0, -8)">JPG</text>
        </g>
      </g>
    </svg>
  }
